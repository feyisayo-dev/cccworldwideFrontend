...
const onSubmit = message => {
  if (message) {
    ...
    const parishCode = userData.parishcode || 'default_parish_code'
      api.post(`/AddAnnouncement/${parishCode}`, {
...
<template>
    ...
    <VCard class="create-app-dialog">
      <VCardText class="pa-5 pa-sm-10">
        ...
        <p class="text-sm text-center mb-8">
          Provide data with this form to create a new Annoucement.
        </p>
                ...
                <VRow>
                  ...
                  >
                    <VTextField
                      ...
                      label="Fill in message for the announcement here"
                      variant="outlined"
                    />
                  </VCol>
  ...
  <ConfirmDialog
    ...
    confirmation-question="You are about to confirm this Annoucement Did you want to continue ?"
